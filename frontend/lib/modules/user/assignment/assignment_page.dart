...
class _UserAssignmentPageState extends State<UserAssignmentPage> {
                ...
                children: [
                  Container(
                    ...
                    height: assignmentCount > 1 
                      ? (assignmentCount * 180.0) - 30 // Dynamic height based on assignments
                      : 150,
                    decoration: BoxDecoration(
                      color: isActiveDay 
                        ? Colors.red.shade600 
  ...
  Widget _buildAssignmentsList() {
    List<Map<String, dynamic>> assignments = _getAssignmentsForDate(selectedDate);
        ...
        'assignments': [
          {
            ...
            'description': 'Review and evaluate new micro-loan applications from local businesses and individuals.',
          ...
          },
          {
            ...
            'description': 'Assist new customers with account opening and banking product orientation.',
        ...
        'assignments': [
          {
            ...
            'description': 'Conduct monthly portfolio risk evaluation and prepare compliance reports.',
        ...
        'assignments': [
          {
            ...
            'description': 'Conduct financial education workshop for local small business owners.',
        ...
        'assignments': [
          {
            ...
            'description': 'Review loan approvals, rejections, and discuss credit policy updates.',
            'time': '09:00 AM - 11:00 AM',
            'priority': 'High',
        ...
        'assignments': [
          {
            ...
            'category': 'Compliance',
            'description': 'Prepare documentation and records for upcoming OJK compliance audit.',
            'time': '02:00 PM - 04:00 PM',
            'priority': 'High',
        ...
        'assignments': [
          {
            ...
            'category': 'Customer Service',
            'description': 'Visit key corporate clients to maintain business relationships and discuss new opportunities.',
  ...
  bool _hasAssignmentOnDate(DateTime date) {
    ...
    List<int> assignmentDays = [5, 12, 15, 18, 22, 28]; // Sample days with banking assignments
      ...
      return [
        {
          ...
          'category': 'Credit Analysis',
          'description': 'Analyze current loan portfolio performance and identify potential risks.',
          'time': '10:00 AM - 12:00 PM',
          'priority': 'High',
          'peopleCount': '5 people',
        },
        {
          ...
          'category': 'Training',
          'description': 'Training on new savings product features and customer presentation techniques.',
          'time': '02:00 PM - 04:00 PM',
          'priority': 'Medium',
          'peopleCount': '8 people',
        },
      ...
      return [
        {
          ...
          'category': 'Finance',
          'description': 'Prepare and review monthly financial statements and regulatory reports.',
          'time': '09:00 AM - 11:00 AM',
          'priority': 'High',
          'peopleCount': '4 people',
        },
      ...
      return [
        {
          ...
          'category': 'Customer Service',
          'description': 'Review customer feedback and implement service improvement strategies.',
      ...
      return [
        {
          ...
          'category': 'Security',
          'description': 'Conduct security audit and update emergency response procedures.',
      ...
      return [
        {
          ...
          'description': 'Visit local businesses to promote BPR services and gather market insights.',
      ...
      return [
        {
          ...
          'category': 'Compliance',
          'description': 'Review compliance with OJK regulations and prepare monthly compliance report.',
